...
<head>
    ...
    <title>KELOMPOK 2 (Dumnny.Cafe)</title>
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand">Dumnny <span>.</span> Cafe</a>
               </div>
                              ...
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                                             ...
                                             <h1>kualitas makanan terbaik juga bisa ada di sini !!</h1>
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="about-info">
                              <div class="section-title wow fadeInUp" data-wow-delay="0.2s">
                                   ...
                                   <h2>Dumnny Food 2021</h2>
                              </div>

                              <div class="wow fadeInUp" data-wow-delay="0.4s">
                                   <p>Weekend emang paling seru makan rame-rame dengan Party Pack! Nikmati serunya Weekendmu ditemani dengan Party Pack dari @dumnny.cafe, Semua menu favorit kamu ada dalam 1 Box!</p>
                                   <p>Jangan lupa untuk follow @dumnny.cafe untuk selalu dapetin info promo menarik lainnya juga yah. Yuk, langsung aja cek aplikasi Grabfood atau Gofood kamu untuk tahu lokasi terdekatmu ya!</p>
                              </div>
                         </div>
                    </div>
